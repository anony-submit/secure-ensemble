...
func TestCIFAR10Ensemble(t *testing.T) {
	configs := []ExperimentConfig{
		// {NumDataOwners: 1, NumTestSamples: 10, Distribution: ""},
		{NumDataOwners: 2, NumTestSamples: 10, Distribution: "balanced"},
		// {NumDataOwners: 2, NumTestSamples: 10, Distribution: "dirichlet0.1"},
		// {NumDataOwners: 2, NumTestSamples: 10, Distribution: "dirichlet0.5"},
		...
		{NumDataOwners: 20, NumTestSamples: 10, Distribution: "balanced"},
...
func checkDataDirectory(t *testing.T, config ExperimentConfig) error {
	testDataPath := filepath.Join("..", "data", "cifar10_test.csv")
