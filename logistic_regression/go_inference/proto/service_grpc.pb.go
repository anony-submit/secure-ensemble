...
const (
	...
	CSPService_RequestPartialDecryptionShare_FullMethodName = "/secure_ensemble.CSPService/RequestPartialDecryptionShare"
)
...
type CSPServiceClient interface {
	...
	// Decryption phase (share-based)
	RequestPartialDecryptionShare(ctx context.Context, in *PartialDecryptionRequest, opts ...grpc.CallOption) (*PartialDecryptionShareResponse, error)
}
...
func (c *cSPServiceClient) RequestPartialDecryptionShare(ctx context.Context, in *PartialDecryptionRequest, opts ...grpc.CallOption) (*PartialDecryptionShareResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PartialDecryptionShareResponse)
	err := c.cc.Invoke(ctx, CSPService_RequestPartialDecryptionShare_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CSPServiceServer interface {
	...
	// Decryption phase (share-based)
	RequestPartialDecryptionShare(context.Context, *PartialDecryptionRequest) (*PartialDecryptionShareResponse, error)
...
func (UnimplementedCSPServiceServer) RequestPartialDecryptionShare(context.Context, *PartialDecryptionRequest) (*PartialDecryptionShareResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestPartialDecryptionShare not implemented")
}
...
func _CSPService_RequestPartialDecryptionShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PartialDecryptionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CSPServiceServer).RequestPartialDecryptionShare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CSPService_RequestPartialDecryptionShare_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CSPServiceServer).RequestPartialDecryptionShare(ctx, req.(*PartialDecryptionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CSPService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RequestPartialDecryptionShare",
			Handler:    _CSPService_RequestPartialDecryptionShare_Handler,
		},
	},
...
const (
	...
	DataOwnerService_PerformPartialDecryptionShare_FullMethodName = "/secure_ensemble.DataOwnerService/PerformPartialDecryptionShare"
)
...
type DataOwnerServiceClient interface {
	...
	// noise flooding share
	PerformPartialDecryptionShare(ctx context.Context, in *PartialDecryptionRequest, opts ...grpc.CallOption) (*PartialDecryptionShareResponse, error)
}
...
func (c *dataOwnerServiceClient) PerformPartialDecryptionShare(ctx context.Context, in *PartialDecryptionRequest, opts ...grpc.CallOption) (*PartialDecryptionShareResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PartialDecryptionShareResponse)
	err := c.cc.Invoke(ctx, DataOwnerService_PerformPartialDecryptionShare_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataOwnerServiceServer interface {
	...
	// noise flooding share
	PerformPartialDecryptionShare(context.Context, *PartialDecryptionRequest) (*PartialDecryptionShareResponse, error)
...
func (UnimplementedDataOwnerServiceServer) PerformPartialDecryptionShare(context.Context, *PartialDecryptionRequest) (*PartialDecryptionShareResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PerformPartialDecryptionShare not implemented")
}
...
func _DataOwnerService_PerformPartialDecryptionShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PartialDecryptionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataOwnerServiceServer).PerformPartialDecryptionShare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataOwnerService_PerformPartialDecryptionShare_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataOwnerServiceServer).PerformPartialDecryptionShare(ctx, req.(*PartialDecryptionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DataOwnerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PerformPartialDecryptionShare",
			Handler:    _DataOwnerService_PerformPartialDecryptionShare_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/service.proto",
